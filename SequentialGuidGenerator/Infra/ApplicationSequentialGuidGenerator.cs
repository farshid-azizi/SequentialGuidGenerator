...
namespace SequentialGuidGenerator.Infra
{
    ...
    public class ApplicationSequentialGuidGenerator : IGuidGenerator
    {
        public SequentialGuidGeneratorOptions Options { get; }

        private static readonly RandomNumberGenerator RandomNumberGenerator = RandomNumberGenerator.Create();

        public ApplicationSequentialGuidGenerator(IOptions<SequentialGuidGeneratorOptions> options)
        {
